...
class Ui_DGU_sistem(object):
    def setupUi(self, DGU_sistem):
        ...
        self.bt_search.setGeometry(QtCore.QRect(80, 430, 90, 26))
        self.bt_search.setObjectName("bt_serch")
        self.bt_add = QtWidgets.QPushButton(DGU_sistem)
        self.bt_add.setGeometry(QtCore.QRect(180, 430, 90, 26))
        self.bt_add.setObjectName("bt_add")
        self.bt_clear = QtWidgets.QPushButton(DGU_sistem)
        self.bt_clear.setGeometry(QtCore.QRect(320, 430, 90, 26))
        self.bt_clear.setObjectName("bt_clear")
        self.bt_creat = QtWidgets.QPushButton(DGU_sistem)
        self.bt_creat.setGeometry(QtCore.QRect(220, 390, 150, 26))
        self.bt_creat.setObjectName("bt_creat")
        self.bt_edit = QtWidgets.QPushButton(DGU_sistem)
        self.bt_edit.setGeometry(QtCore.QRect(415, 430, 90, 26))
        self.bt_edit.setObjectName("bt_edit")
        self.bt_delete = QtWidgets.QPushButton(DGU_sistem)
        self.bt_delete.setGeometry(QtCore.QRect(130, 390, 90, 26))
        self.bt_delete.setObjectName("bt_delete")
        self.bt_import = QtWidgets.QPushButton(DGU_sistem)
        self.bt_import.setGeometry(QtCore.QRect(380, 390, 90, 26))
